...
你可以在本地直接打开任意文件夹里的HTML文件，也可以部署到任何支持静态文件的地方（GitHub Pages、Netlify 等）。
...
**开玩笑的，上面说的“想怎么折腾都行”不算数——这个项目其实用的是 AGPLv3 许可证。**

如果你使用、修改或分发它（哪怕是通过网络提供服务），你也必须以相同许可证开源你的修改。公平交易，对吧？就当是我给开源轮回的一点贡献。
